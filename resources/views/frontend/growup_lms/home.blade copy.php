            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-7 col-lg-6 col-md-6 order-2 order-md-1 ">
                    <div class="md-max-w-584px">
                        ...
                        <p class="man-subtitle3-16px mb-32px pe-xl-4">{{ get_phrase('An advanced LMS that turns your learning Into earning potentials.Share what you know and earn money on your own terms.') }}<span class="fw-medium cin2-text-dark">Turn your knowledge into business opportunity.</span></p>
