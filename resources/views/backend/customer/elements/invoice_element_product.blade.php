        ...
        <div class="invoice-items">
            <div class="invoice-item">
                <div class="invoice-info">
                    <h5 class="title">{{ get_phrase('Bill to').' '.$invoice_details->payment_to_user->name}}</h5>
                    <p class="info">
            ...
            <div class="invoice-item">
                ...
                <div class="invoice-info">
                    ...
                    <p class="info">{{ date('d M, Y', $invoice_details->date_added) }}</p>
                </div>
                <div class="invoice-info">
                    <span class="paid">{{ get_phrase('Paid').' - '.currency($invoice_details->paid_amount) }}</span>
                </div>
            </div>
        </div>
        <!-- Table -->
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="dl_property_price">
                                <p>{{ date('d M, Y', $invoice_details->date_added) }}</p>
                            </div>
                        </td>
                        <td>
                            <div class="dl_property_id">
